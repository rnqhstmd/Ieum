...
> **이음 적응 노트**: 실제 구현은 한글 친화를 위해 D-DIN/Inter 대신 **Pretendard**를 사용한다(`screen-prompts.md` 적응 규칙 B). 디스플레이/버튼/eyebrow의 대문자·넓은 트래킹 무드는 유지하되, 본문·에디터는 sentence-case + line-height 1.5~1.7.
