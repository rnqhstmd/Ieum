...
> 이 매핑은 requirements 구현 phase 계획 기준: 개인 워크스페이스 자동생성·사이드바 목록/전환 → **P2**, 공유 워크스페이스 생성·삭제·멤버 관리·초대 → **P7**.
...
| US-INV-03 | OWNER가 MEMBER 역할 변경·내보내기 | OWNER가 MEMBER에게 OWNER 역할 부여 가능 | ⬜ | P7 | |
| US-INV-03 | 〃 | OWNER가 MEMBER를 내보낼 수 있음 (Membership 삭제) | ⬜ | P7 | |
| US-INV-03 | 〃 | 마지막 OWNER는 역할 변경·나가기 불가 | ⬜ | P7 | |
| US-INV-04 | OWNER가 보류 중 초대 취소 | OWNER가 PENDING 초대를 REVOKED로 변경 가능 | ⬜ | P7 | |
...
| P7 | 공유 워크스페이스 생성·삭제, 초대, OWNER/MEMBER 역할, 권한 매트릭스 | US-WS-02~04, US-INV-01~04 |
