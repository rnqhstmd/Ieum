...
| US-EDIT (CRDT) | — | 에디터 내용은 RGA CRDT 상태로 관리, 렌더링은 CRDT 상태에서 파생 | ⬜ | P11 | CRDT 블록 모델·`docToBlocks` 도출은 P4b 완료(PR #9, `@ieum/crdt`). 인라인 타이핑 라이브 수렴은 P5(PR #10). 구조편집(Enter/Backspace 블록 op) 완전 배선은 P11 |
